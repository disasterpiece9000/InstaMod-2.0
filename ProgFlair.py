class ProgFlair:
    ...
    def make_prog_flair(self, user, sub):
        ...
        while True:
            ...
            if tier_name in prog_tiers:
                ...
                main_result = self.user_in_tier(main_tier, user, sub)
                ...
                if tier_name_and in prog_tiers:
                    ...
                    and_result = self.user_in_tier(and_tier, user, sub)

                elif tier_name_or in prog_tiers:
                    or_tier = prog_tiers[tier_name_or]
                    or_result = self.user_in_tier(or_tier, user, sub)
    ...
    def user_in_tier(self, tier, user, sub):
        ...
        return self.check_value(user_value, comparison, value)
